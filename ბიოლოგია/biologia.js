...
function bavshvisTmisFeri() { 
    ...
    if((dedis == 'cisq') && (mamis == 'cisk')){
        ...
        document.getElementById('baganastvalisferi').innerHTML=(' ბავშვის თვალის ფერი იქნება 50% მწვანე, 50% ცისფერი')
    }else if((dedis == 'mwvq') && (mamis == 'mwvk')){
        document.getElementById('baganastvalisferi').innerHTML=(' ბავშვის თვალის ფერი იქნება 75% მწვანე, 25% ცისფერი')
        ...
        document.getElementById('baganastvalisferi').innerHTML=(' ბავშვის თვალის ფერი იქნება 75% ყავისფერი, 20% მწვანე, 5% ცისფერი')
    }
}  